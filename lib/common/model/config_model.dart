...
class ConfigContent {
  ...
  int? _maxVideoUploadSize;
  ProviderLoginSetup? _loginSetup;
  Map<String, Map<String, String?>>? _mobileAppIcons;
  ...
  ConfigContent({
    ...
    if(maxImageUploadSize != null) {
      _maxImageUploadSize = maxImageUploadSize;
    }
    if(maxVideoUploadSize != null) {
      _maxVideoUploadSize = maxVideoUploadSize;
    }
  ...
  int? get maxVideoUploadSize => _maxVideoUploadSize;
  ProviderLoginSetup? get loginSetup => _loginSetup;
  Map<String, Map<String, String?>>? get mobileAppIcons => _mobileAppIcons;
  ...
  ConfigContent.fromJson(Map<String, dynamic> json) {
    ...
    _businessPages = _filterHiddenBusinessPages(
    ...
    _maxVideoUploadSize = int.tryParse(json['max_video_upload_size'].toString());
    _loginSetup = json['login_setup'] != null
        ? ProviderLoginSetup.fromJson(json['login_setup'])
        : null;
    _mobileAppIcons = _parseMobileAppIcons(json['mobile_app_icons']);
  ...
  Map<String, dynamic> toJson() {
    ...
    data['max_video_upload_size'] = _maxVideoUploadSize;
...
class ProviderLoginSetup {
  LoginOption? loginOption;

  ProviderLoginSetup({this.loginOption});

  ProviderLoginSetup.fromJson(Map<String, dynamic> json) {
...
class LoginOption {
  ...
  LoginOption({this.manualLogin, this.otpLogin});

  LoginOption.fromJson(Map<String, dynamic> json) {
    manualLogin = _parseLoginFlag(json['manual_login'], defaultValue: 1);
    otpLogin = _parseLoginFlag(json['otp_login'], defaultValue: 0);
  }

  static int _parseLoginFlag(dynamic value, {required int defaultValue}) {
    if (value == null) {
      return defaultValue;
    }
    if (value is int) {
