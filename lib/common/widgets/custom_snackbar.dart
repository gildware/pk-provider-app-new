              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  if(toasterTitle !=null) Padding(
                    ...
                    child: Text(trLabel(toasterTitle), style: robotoMedium.copyWith(color : Colors.white, ), maxLines: 3, overflow: TextOverflow.ellipsis,),
                  ),
                  Text(trLabel(message), style: robotoRegular.copyWith(color : Colors.white.withValues(alpha:0.8), height: toasterTitle !=null ?  1.0 : 1.2), maxLines: 3, overflow: TextOverflow.ellipsis),
                ]),
              ),
            ]),
          ),
