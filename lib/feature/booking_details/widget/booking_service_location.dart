...
class BookingServiceLocation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  GetBuilder<BookingDetailsController>(builder: (bookingDetailsController){
      ...
      String? serviceLocation = nextBooking?.serviceLocation ??
          bookingDetails.serviceLocationDetails?.serviceLocation ??
          bookingDetails.serviceLocation;
      final ServiceLocationDetails? locDetails =
          bookingDetails.serviceLocationDetails;
          ...
          children: [
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, spacing: Dimensions.paddingSizeSmall, children: [
                ...
                if (locDetails?.zoneName != null && locDetails!.zoneName!.isNotEmpty)
                  BookingOverviewKvRow(
                    title: 'zone'.tr,
                    value: locDetails.zoneName!,
                  ),
                ...
                Row(spacing: Dimensions.paddingSizeDefault ,children: [
                  Expanded(child: Text(
                    locDetails?.addressPending == true
                        ? 'service_location_pending_provider'.tr
                        : (locDetails?.address?.isNotEmpty == true
                            ? locDetails!.address!
