      ...
      return Container(
        ...
        child: Column( crossAxisAlignment: CrossAxisAlignment.start ,children: [
          ...
          BottomCard(
            ...
            showRating: true,
            avgRating: bookingDetails.customer?.receivedAvgRating ?? bookingDetails.subBooking?.customer?.receivedAvgRating ?? 0,
            ratingCount: bookingDetails.customer?.receivedRatingCount ?? bookingDetails.subBooking?.customer?.receivedRatingCount ?? 0,
          )
