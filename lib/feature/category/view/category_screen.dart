...
class _AllServicesScreenState extends State<AllServicesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: MainAppBar(title: 'available_services', color: context.adaptivePrimaryColor, showBackButton: true),
        ...
        body: Column(
          ...
          children: [
            ...
            Expanded(
              child: GetBuilder<ServiceCategoryController>(builder: (allServiceController) {
