...
class TabBarDelegate extends SliverPersistentHeaderDelegate {
              ...
              child: Container(
                ...
                child: TabBar(
                  ...
                  onTap: (int? index) {
                    ...
                    serviceTabController.controller?.index = index;
                    switch (index) {
                      case 0:
  ...
  @override
  double get maxExtent => Dimensions.paddingSizeExtraLarge * 2;

  @override
  double get minExtent => Dimensions.paddingSizeExtraLarge * 2;
