...
class SubscriptionInvoice {
  ...
  static pw.SpanningWidget buildSimpleText({String? title, String? subtitle, TextAlign textAlign = TextAlign.start }) {
  ...
  static pw.ConstrainedBox buildTitleText({String ? title,  String ? subtitle, TextStyle? style, CrossAxisAlignment crossAxisAliment = pw.CrossAxisAlignment.start }) {
