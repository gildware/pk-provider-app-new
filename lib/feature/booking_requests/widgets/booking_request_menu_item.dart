      ...
      child: Row(
        ...
        children: [
          ...
          bookingCount != null ? Container(
            ...
            child: Text(
              title == "all"
                  ? bookingCount == null ? "" : "$allBookingCount"
                  : title == "accepted"
                      ? bookingCount?.accepted == null ? "" : "${bookingCount?.accepted}"
                      : title == "ongoing"
                          ? bookingCount?.ongoing == null ? "" : "${bookingCount?.ongoing}"
                          : title == "on_hold"
                              ? bookingCount?.onHold == null ? "" : "${bookingCount?.onHold}"
                              : title == "completed"
                                  ? bookingCount?.completed == null ? "" : "${bookingCount?.completed}"
                                  : title == "canceled"
                                      ? bookingCount?.canceled == null ? "" : "${bookingCount?.canceled}"
                                      : title == "refunded"
                                          ? bookingCount?.refunded == null ? "" : "${bookingCount?.refunded}"
                                          : bookingCount?.pending == null ? "" : "${bookingCount?.pending}",
