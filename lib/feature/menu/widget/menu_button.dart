  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () async {
        ...
        else if (menu?.route == RouteHelper.allServices) {
          Get.back();
          Get.toNamed(RouteHelper.getAllServicesRoute());
        }
        else {
          if(menu?.route == RouteHelper.businessPlan || menu?.route == RouteHelper.profile || menu?.route == RouteHelper.transactions || menu?.route == RouteHelper.payments || menu!.route!.contains(RouteHelper.html) || menu?.route == RouteHelper.mySubscription){
