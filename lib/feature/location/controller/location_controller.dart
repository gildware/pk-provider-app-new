...
class LocationController extends GetxController  implements GetxService{
  ...
  Future<void> getCurrentLocation(bool fromAddress, {GoogleMapController? mapController, LatLng? defaultLatLng, bool notify = true}) async {
    ...
    try {
      final address = await getAddressFromGeocode(LatLng(myPosition.latitude, myPosition.longitude));
      if (fromAddress) {
        _address = address;
      } else {
  ...
  Future<void> initializePickMapPosition(LatLng latLng, {GoogleMapController? mapController}) async {
    _pickPosition = Position(
    ...
    await _resolvePickAddressFromLatLng(latLng);
  }
